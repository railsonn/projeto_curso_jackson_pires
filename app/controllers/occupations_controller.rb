class OccupationsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @occupation.update(occupation_params)
        format.html { redirect_to @occupation, notice: "Occupation was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to occupations_path, notice: "Occupation was successfully destroyed.", status: :see_other }

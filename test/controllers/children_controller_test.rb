...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference("Child.count") do
      post children_url, params: { child: { Father_id: @child.Father_id, name: @child.name, sex: @child.sex } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { Father_id: @child.Father_id, name: @child.name, sex: @child.sex } }
